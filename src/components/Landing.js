              ...
              {features.map((feature) => (
                <div key={feature.name}>
                  ...
                  <div className="mt-5">
                    ...
                    <p className="mt-2 text-base text-gray-100 frontbutton text-center"><a href={feature.github}>On github</a></p>
                    <p className="mt-2 text-base text-gray-100 frontbutton text-center"><a href={feature.website}>Visit Website</a></p>
